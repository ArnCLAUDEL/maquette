package maquette.repository;

import maquette.MaquetteApp;
import maquette.config.Constants;
import maquette.config.audit.AuditEventConverter;
import maquette.domain.PersistentAuditEvent;
...
import static maquette.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
